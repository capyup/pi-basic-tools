...
The test suite validates the package search-extension registration, WebFetch behavior, and the ripgrep argument behavior used by `glob` and `grep`.
...
Please credit upstream work when porting features from other pi extensions.
